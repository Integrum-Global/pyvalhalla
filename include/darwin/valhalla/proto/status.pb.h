...
class Status final :
 ...
 public:
  ...
  void set_allocated_bbox(std::string* ptr);
 ...
 private:
  ...
  static const ::google::protobuf::internal::TcParseTable<2, 10, 0, 60, 2> _table_;
...
inline PROTOBUF_ALWAYS_INLINE void Status::set_bbox(Arg_&& arg,
  ...
  _impl_.has_bbox_.bbox_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void Status::set_allocated_bbox(std::string* value) {
  ...
  if (value != nullptr) {
    set_has_bbox();
    _impl_.has_bbox_.bbox_.InitAllocated(value, GetArenaForAllocation());
  }
...
inline ::google::protobuf::RepeatedPtrField<std::string>* Status::mutable_available_actions() {
