...
class IncidentsTile_Metadata final :
 ...
 public:
  ...
  void set_allocated_sub_type(std::string* ptr);
  ...
  void set_allocated_sub_type_description(std::string* ptr);
  ...
  void set_allocated_clear_lanes(std::string* ptr);
  ...
  void set_allocated_iso_3166_1_alpha2(std::string* ptr);
  ...
  void set_allocated_iso_3166_1_alpha3(std::string* ptr);
 ...
 private:
  ...
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<5, 19, 1, 169, 7> _table_;
  template <typename T> friend class ::google::protobuf::Arena::InternalHelper;
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  struct Impl_ {
...
inline const ::google::protobuf::RepeatedField<::uint32_t>& IncidentsTile_Metadata::_internal_alertc_codes() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
...
inline PROTOBUF_ALWAYS_INLINE void IncidentsTile_Metadata::set_sub_type(Arg_&& arg,
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.sub_type_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void IncidentsTile_Metadata::set_allocated_sub_type(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.sub_type_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline PROTOBUF_ALWAYS_INLINE void IncidentsTile_Metadata::set_sub_type_description(Arg_&& arg,
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.sub_type_description_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void IncidentsTile_Metadata::set_allocated_sub_type_description(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.sub_type_description_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void IncidentsTile_Metadata::set_allocated_congestion(::valhalla::IncidentsTile_Metadata_Congestion* value) {
  ...
  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena =
        ::google::protobuf::Arena::InternalGetOwningArena(reinterpret_cast<::valhalla::IncidentsTile_Metadata_Congestion*>(value));
...
inline ::google::protobuf::RepeatedPtrField<std::string>* IncidentsTile_Metadata::mutable_lanes_blocked() {
...
inline PROTOBUF_ALWAYS_INLINE void IncidentsTile_Metadata::set_clear_lanes(Arg_&& arg,
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.clear_lanes_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void IncidentsTile_Metadata::set_allocated_clear_lanes(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.clear_lanes_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline PROTOBUF_ALWAYS_INLINE void IncidentsTile_Metadata::set_iso_3166_1_alpha2(Arg_&& arg,
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.iso_3166_1_alpha2_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void IncidentsTile_Metadata::set_allocated_iso_3166_1_alpha2(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.iso_3166_1_alpha2_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline PROTOBUF_ALWAYS_INLINE void IncidentsTile_Metadata::set_iso_3166_1_alpha3(Arg_&& arg,
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.iso_3166_1_alpha3_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void IncidentsTile_Metadata::set_allocated_iso_3166_1_alpha3(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.iso_3166_1_alpha3_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
