...
inline const ::google::protobuf::RepeatedField<::uint32_t>& Transit_StopPair::_internal_service_added_dates() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
...
inline const ::google::protobuf::RepeatedField<bool>& Transit_StopPair::_internal_service_days_of_week() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
...
inline const ::google::protobuf::RepeatedField<::uint32_t>& Transit_StopPair::_internal_service_except_dates() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
